...
enum ZoneType {
    ...
    ARBITES_PRECINCT_EDGE("Civic Wardens Precinct Edge", "public counter rooms, holding pens, checkpoint halls", 2, -2),
    MECHANICUS_RELIC_DUCT("Mechanist Collegia Relic Duct", "machine alcoves, cable vaults, old EMM pads", 5, 2),
    ...
    ADMINISTRATUM_ARCHIVE("Civic Ledger Office Archive", "paper catacombs, queue halls, permit cages, stamped misery", 3, -1),
    IMPERIAL_GUARD_BILLET("Concord Guard Billet", "barracks overflow, armory cages, rations, bored soldiers", 3, -2),
    MECHANICUS_FORGE_CLOISTER("Mechanist Collegia Forge Cloister", "red-lit shrines, machine cells, manufactorum ducts", 5, 2),
    ...
    IMPERIAL_NEWS_NETWORK("Concord News Network Bureau", "newsprint rooms, editorial desks, vox studios, pict-screen booths, public distributors, and sanctioned omissions", 4, 1),
