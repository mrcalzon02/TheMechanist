...
enum Faction {
    ...
    // Legacy enum constants are retained for save/profile compatibility; labels are Concord-neutralized.
    ADMINISTRATUM("Civic Ledger Office"),
    ARBITES("Civic Wardens"),
    IMPERIAL_GUARD("Concord Guard"),
    MINISTORUM("Covenant Ministry"),
    INN("Concord News Network"),
    SORORITAS("Covenant Temple Guard"),
    MECHANICUS("Mechanist Forge"),

    // Neutral aliases used by newly strip-mined generation code.
    CIVIC_LEDGER_OFFICE("Civic Ledger Office"),
    CIVIC_WARDENS("Civic Wardens"),
    MECHANIST_COLLEGIA("Mechanist Collegia"),
