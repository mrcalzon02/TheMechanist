...
Generated/evaluated: `2026-07-12 16:22:48`
...
- `COMBAT_SIM`: `46` modules
- `DIAGNOSTIC_DOC`: `157` modules
- `FIXTURE_MACHINE`: `29` modules
- `INVENTORY_PERSIST`: `27` modules
- `LOCALIZATION_TEXT`: `95` modules
- `RUNTIME_OPTIONS`: `35` modules
- `SERVER_AUTH`: `39` modules
- `UI_INPUT`: `63` modules
- `UI_RENDER`: `124` modules
- `WORLD_GEN`: `81` modules

## Status Counts

- `positioned`: `738` modules
...
flowchart TD
    ...
    ROOT --> ERRORS
    ROOT --> Z_LOCALIZATION_TEXT["Localization Text<br/>95 modules"]
    ...
    Z_LOCALIZATION_TEXT --> M_src_mechanist_ProgressiveConstructionAuthority_java["src/mechanist/ProgressiveConstructionAuthority.java<br/>62 funcs / 673 lines"]
    ...
    Z_LOCALIZATION_TEXT --> M_src_mechanist_FactionReinforcementAuthority_java["src/mechanist/FactionReinforcementAuthority.java<br/>28 funcs / 413 lines"]
    Z_LOCALIZATION_TEXT --> M_src_mechanist_FactionCrecheAuthority_java["src/mechanist/FactionCrecheAuthority.java<br/>21 funcs / 408 lines"]
    ...
    Z_LOCALIZATION_TEXT --> M_src_mechanist_PersistenceFramework_java["src/mechanist/PersistenceFramework.java<br/>19 funcs / 370 lines"]
    Z_LOCALIZATION_TEXT --> M_src_mechanist_ArtPackManager_java["src/mechanist/ArtPackManager.java<br/>19 funcs / 360 lines"]
    Z_LOCALIZATION_TEXT --> Z_LOCALIZATION_TEXT_OTHER["+ 83 smaller modules"]
    ROOT --> Z_UI_RENDER["UI Render Surfaces<br/>124 modules"]
    Z_UI_RENDER --> M_src_mechanist_LegacyPanelContext_java["src/mechanist/LegacyPanelContext.java<br/>601 funcs / 7700 lines"]
    ...
    Z_UI_RENDER --> Z_UI_RENDER_OTHER["+ 112 smaller modules"]
    ...
    Z_UI_INPUT --> M_src_mechanist_GameplayConsoleCommandAuthority_java["src/mechanist/GameplayConsoleCommandAuthority.java<br/>48 funcs / 327 lines"]
    ...
    Z_UI_INPUT --> M_src_mechanist_ContractObjectiveReadabilityAuthority_java["src/mechanist/ContractObjectiveReadabilityAuthority.java<br/>12 funcs / 211 lines"]
    ...
    Z_WORLD_GEN --> M_src_mechanist_WorldRuntimeGenerationFramework_java["src/mechanist/WorldRuntimeGenerationFramework.java<br/>377 funcs / 8293 lines"]
    ...
    Z_WORLD_GEN --> M_src_mechanist_ZoneTileState_java["src/mechanist/ZoneTileState.java<br/>50 funcs / 222 lines"]
    ...
    ROOT --> Z_INVENTORY_PERSIST["Inventory Items Persistence<br/>27 modules"]
    ...
    Z_INVENTORY_PERSIST --> M_src_mechanist_ContainerTradeFramework_java["src/mechanist/ContainerTradeFramework.java<br/>92 funcs / 809 lines"]
    ...
    Z_INVENTORY_PERSIST --> M_src_mechanist_TradeReadabilityAuthority_java["src/mechanist/TradeReadabilityAuthority.java<br/>18 funcs / 202 lines"]
    ...
    Z_INVENTORY_PERSIST --> M_src_mechanist_ItemSemanticAssetAuthority_java["src/mechanist/ItemSemanticAssetAuthority.java<br/>8 funcs / 156 lines"]
    Z_INVENTORY_PERSIST --> M_src_mechanist_Milestone04VerticalFloorTradeSmoke_java["src/mechanist/Milestone04VerticalFloorTradeSmoke.java<br/>9 funcs / 134 lines"]
    ...
    Z_INVENTORY_PERSIST --> Z_INVENTORY_PERSIST_OTHER["+ 15 smaller modules"]
    ROOT --> Z_FIXTURE_MACHINE["Fixtures Machines<br/>29 modules"]
    Z_FIXTURE_MACHINE --> M_src_mechanist_ProductionAuthorityFramework_java["src/mechanist/ProductionAuthorityFramework.java<br/>319 funcs / 3136 lines"]
    ...
    ROOT --> Z_COMBAT_SIM["Combat Entity Simulation<br/>46 modules"]
    ...
    Z_COMBAT_SIM --> M_src_mechanist_PopulationPersonnelFramework_java["src/mechanist/PopulationPersonnelFramework.java<br/>122 funcs / 1301 lines"]
    Z_COMBAT_SIM --> M_src_mechanist_FactionServicesFramework_java["src/mechanist/FactionServicesFramework.java<br/>110 funcs / 973 lines"]
    ...
    Z_COMBAT_SIM --> Z_COMBAT_SIM_OTHER["+ 34 smaller modules"]
    ...
    Z_ASSET_REGISTRY --> M_src_mechanist_SemanticAssetInfopediaAuthority_java["src/mechanist/SemanticAssetInfopediaAuthority.java<br/>25 funcs / 511 lines"]
    ...
    ROOT --> Z_DIAGNOSTIC_DOC["Diagnostics Smoke Audit<br/>157 modules"]
    ...
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Milestone02InfopediaMechanicsReadabilitySmoke_java["src/mechanist/Milestone02InfopediaMechanicsReadabilitySmoke.java<br/>7 funcs / 226 lines"]
    ...
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Milestone03ProductionContractWorkflowSmoke_java["src/mechanist/Milestone03ProductionContractWorkflowSmoke.java<br/>12 funcs / 198 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Gate3PlayerFacingTextSmokeSuite_java["src/mechanist/Gate3PlayerFacingTextSmokeSuite.java<br/>2 funcs / 196 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Milestone04ReinforcementSourcePolicySmoke_java["src/mechanist/Milestone04ReinforcementSourcePolicySmoke.java<br/>12 funcs / 187 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Milestone04FactionReinforcementLifecycleSmoke_java["src/mechanist/Milestone04FactionReinforcementLifecycleSmoke.java<br/>10 funcs / 184 lines"]
    ...
    Z_DIAGNOSTIC_DOC --> Z_DIAGNOSTIC_DOC_OTHER["+ 145 smaller modules"]
```
