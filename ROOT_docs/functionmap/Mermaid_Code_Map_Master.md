...
Generated/evaluated: `2026-06-13 22:24:55`
...
- Java modules mapped: `526`
- Unpositioned modules: `0`
- Oversized mapped modules: `13`

## Zone Counts

- `ASSET_REGISTRY`: `26` modules
- `COMBAT_SIM`: `38` modules
- `DIAGNOSTIC_DOC`: `56` modules
- `FIXTURE_MACHINE`: `23` modules
- `INVENTORY_PERSIST`: `22` modules
- `LOCALIZATION_TEXT`: `74` modules
- `RUNTIME_OPTIONS`: `36` modules
- `SERVER_AUTH`: `39` modules
- `UI_INPUT`: `58` modules
- `UI_RENDER`: `108` modules
- `WORLD_GEN`: `46` modules

## Status Counts

- `positioned`: `526` modules
...
flowchart TD
    ...
    ROOT --> ERRORS
    ROOT --> Z_LOCALIZATION_TEXT["Localization Text<br/>74 modules"]
    ...
    Z_LOCALIZATION_TEXT --> M_src_mechanist_PersistenceFramework_java["src/mechanist/PersistenceFramework.java<br/>19 funcs / 359 lines"]
    ...
    Z_LOCALIZATION_TEXT --> Z_LOCALIZATION_TEXT_OTHER["+ 62 smaller modules"]
    ROOT --> Z_UI_RENDER["UI Render Surfaces<br/>108 modules"]
    Z_UI_RENDER --> M_src_mechanist_LegacyPanelContext_java["src/mechanist/LegacyPanelContext.java<br/>505 funcs / 5964 lines"]
    Z_UI_RENDER --> M_src_mechanist_SimulationEditorSuite_java["src/mechanist/SimulationEditorSuite.java<br/>111 funcs / 1687 lines"]
    Z_UI_RENDER --> M_src_mechanist_FirstPerson3DFramework_java["src/mechanist/FirstPerson3DFramework.java<br/>110 funcs / 1246 lines"]
    ...
    Z_UI_RENDER --> M_src_mechanist_GamePanelKeyController_java["src/mechanist/GamePanelKeyController.java<br/>20 funcs / 405 lines"]
    ...
    Z_UI_RENDER --> Z_UI_RENDER_OTHER["+ 96 smaller modules"]
    ROOT --> Z_UI_INPUT["UI Input Navigation<br/>58 modules"]
    ...
    Z_UI_INPUT --> M_src_mechanist_GamepadInputEngine_java["src/mechanist/GamepadInputEngine.java<br/>15 funcs / 150 lines"]
    Z_UI_INPUT --> M_src_mechanist_PlayerBehaviorMonitor_java["src/mechanist/PlayerBehaviorMonitor.java<br/>13 funcs / 149 lines"]
    Z_UI_INPUT --> Z_UI_INPUT_OTHER["+ 46 smaller modules"]
    ROOT --> Z_RUNTIME_OPTIONS["Runtime Options<br/>36 modules"]
    ...
    Z_RUNTIME_OPTIONS --> Z_RUNTIME_OPTIONS_OTHER["+ 24 smaller modules"]
    ROOT --> Z_WORLD_GEN["World Generation Transition<br/>46 modules"]
    Z_WORLD_GEN --> M_src_mechanist_WorldRuntimeGenerationFramework_java["src/mechanist/WorldRuntimeGenerationFramework.java<br/>377 funcs / 8292 lines"]
    ...
    Z_WORLD_GEN --> Z_WORLD_GEN_OTHER["+ 34 smaller modules"]
    ROOT --> Z_INVENTORY_PERSIST["Inventory Items Persistence<br/>22 modules"]
    Z_INVENTORY_PERSIST --> M_src_mechanist_ItemEconomyFramework_java["src/mechanist/ItemEconomyFramework.java<br/>72 funcs / 1418 lines"]
    ...
    Z_INVENTORY_PERSIST --> M_src_mechanist_TradeReadabilityAuthority_java["src/mechanist/TradeReadabilityAuthority.java<br/>9 funcs / 98 lines"]
    ...
    Z_INVENTORY_PERSIST --> Z_INVENTORY_PERSIST_OTHER["+ 10 smaller modules"]
    ROOT --> Z_FIXTURE_MACHINE["Fixtures Machines<br/>23 modules"]
    Z_FIXTURE_MACHINE --> M_src_mechanist_ProductionAuthorityFramework_java["src/mechanist/ProductionAuthorityFramework.java<br/>316 funcs / 3117 lines"]
    ...
    Z_FIXTURE_MACHINE --> Z_FIXTURE_MACHINE_OTHER["+ 11 smaller modules"]
    ROOT --> Z_COMBAT_SIM["Combat Entity Simulation<br/>38 modules"]
    Z_COMBAT_SIM --> M_src_mechanist_WorldSimulationFramework_java["src/mechanist/WorldSimulationFramework.java<br/>206 funcs / 1815 lines"]
    Z_COMBAT_SIM --> M_src_mechanist_PopulationPersonnelFramework_java["src/mechanist/PopulationPersonnelFramework.java<br/>122 funcs / 1270 lines"]
    Z_COMBAT_SIM --> M_src_mechanist_FactionServicesFramework_java["src/mechanist/FactionServicesFramework.java<br/>106 funcs / 944 lines"]
    ...
    Z_COMBAT_SIM --> M_src_mechanist_Milestone02MovementPlanningReadabilitySmoke_java["src/mechanist/Milestone02MovementPlanningReadabilitySmoke.java<br/>8 funcs / 146 lines"]
    Z_COMBAT_SIM --> Z_COMBAT_SIM_OTHER["+ 26 smaller modules"]
    ROOT --> Z_ASSET_REGISTRY["Asset Registry Art<br/>26 modules"]
    ...
    Z_ASSET_REGISTRY --> M_src_mechanist_SemanticAssetInfopediaAuthority_java["src/mechanist/SemanticAssetInfopediaAuthority.java<br/>24 funcs / 411 lines"]
    ...
    Z_ASSET_REGISTRY --> Z_ASSET_REGISTRY_OTHER["+ 14 smaller modules"]
    ...
    ROOT --> Z_DIAGNOSTIC_DOC["Diagnostics Smoke Audit<br/>56 modules"]
    ...
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Milestone02InfopediaMechanicsReadabilitySmoke_java["src/mechanist/Milestone02InfopediaMechanicsReadabilitySmoke.java<br/>6 funcs / 93 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Milestone02MenuUniformityReadabilitySmoke_java["src/mechanist/Milestone02MenuUniformityReadabilitySmoke.java<br/>7 funcs / 87 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_WorldGenerationSetupPersistenceSmoke_java["src/mechanist/WorldGenerationSetupPersistenceSmoke.java<br/>5 funcs / 80 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Gate3PlayerFacingTextSmokeSuite_java["src/mechanist/Gate3PlayerFacingTextSmokeSuite.java<br/>2 funcs / 77 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Milestone03QualityProvenanceSmoke_java["src/mechanist/Milestone03QualityProvenanceSmoke.java<br/>4 funcs / 74 lines"]
    Z_DIAGNOSTIC_DOC --> Z_DIAGNOSTIC_DOC_OTHER["+ 44 smaller modules"]
```
