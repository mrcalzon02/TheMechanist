...
Generated/evaluated: `2026-06-01 14:51:11`
...
- `COMBAT_SIM`: `19` modules
- `DIAGNOSTIC_DOC`: `17` modules
- `FIXTURE_MACHINE`: `17` modules
- `INVENTORY_PERSIST`: `11` modules
- `RUNTIME_OPTIONS`: `27` modules
- `SERVER_AUTH`: `39` modules
- `UI_INPUT`: `53` modules
- `UI_RENDER`: `133` modules
- `WORLD_GEN`: `27` modules

## Status Counts

- `positioned`: `365` modules

## Explicit Override Rule

Explicit `MODULE_OVERRIDES` entries in `scripts/BUILD_MERMAID_CODE_MAP.py` beat broad keyword heuristics. Add an override when a known owner is misclassified by generic words such as render, panel, or audit.
...
flowchart TD
    ...
    ROOT --> ERRORS
    ROOT --> Z_UI_RENDER["UI Render Surfaces<br/>133 modules"]
    ...
    Z_UI_RENDER --> M_src_mechanist_MediaRuntimeFramework_java["src/mechanist/MediaRuntimeFramework.java<br/>41 funcs / 553 lines"]
    Z_UI_RENDER --> M_src_mechanist_SaveEfficiencyAuthority_java["src/mechanist/SaveEfficiencyAuthority.java<br/>38 funcs / 482 lines"]
    ...
    Z_UI_RENDER --> M_src_mechanist_AudioRuntimeFramework_java["src/mechanist/AudioRuntimeFramework.java<br/>43 funcs / 424 lines"]
    ...
    Z_UI_RENDER --> M_src_mechanist_EnvironmentSensesFramework_java["src/mechanist/EnvironmentSensesFramework.java<br/>68 funcs / 401 lines"]
    Z_UI_RENDER --> M_src_mechanist_ArtPackManager_java["src/mechanist/ArtPackManager.java<br/>19 funcs / 360 lines"]
    Z_UI_RENDER --> Z_UI_RENDER_OTHER["+ 121 smaller modules"]
    ...
    ROOT --> Z_RUNTIME_OPTIONS["Runtime Options<br/>27 modules"]
    ...
    Z_RUNTIME_OPTIONS --> Z_RUNTIME_OPTIONS_OTHER["+ 15 smaller modules"]
    ROOT --> Z_WORLD_GEN["World Generation Transition<br/>27 modules"]
    Z_WORLD_GEN --> M_src_mechanist_WorldRuntimeGenerationFramework_java["src/mechanist/WorldRuntimeGenerationFramework.java<br/>351 funcs / 8140 lines"]
    ...
    Z_WORLD_GEN --> M_src_mechanist_RoadGridIntegrationAuthority_java["src/mechanist/RoadGridIntegrationAuthority.java<br/>13 funcs / 203 lines"]
    ...
    Z_WORLD_GEN --> Z_WORLD_GEN_OTHER["+ 15 smaller modules"]
    ROOT --> Z_INVENTORY_PERSIST["Inventory Items Persistence<br/>11 modules"]
    ...
    Z_INVENTORY_PERSIST --> M_src_mechanist_FallbackProfileManagementAuthority_java["src/mechanist/FallbackProfileManagementAuthority.java<br/>46 funcs / 640 lines"]
    ...
    Z_INVENTORY_PERSIST --> M_src_mechanist_modapi_ItemTemplate_java["src/mechanist/modapi/ItemTemplate.java<br/>17 funcs / 47 lines"]
    Z_INVENTORY_PERSIST --> M_src_mechanist_InventoryPanelKeyController_java["src/mechanist/InventoryPanelKeyController.java<br/>2 funcs / 45 lines"]
    Z_INVENTORY_PERSIST --> M_src_mechanist_modapi_examples_LocalizedGravityAnchorItemMod_java["src/mechanist/modapi/examples/LocalizedGravityAnchorItemMod.java<br/>0 funcs / 42 lines"]
    ...
    ROOT --> Z_FIXTURE_MACHINE["Fixtures Machines<br/>17 modules"]
    ...
    Z_FIXTURE_MACHINE --> Z_FIXTURE_MACHINE_OTHER["+ 5 smaller modules"]
    ROOT --> Z_COMBAT_SIM["Combat Entity Simulation<br/>19 modules"]
    ...
    Z_COMBAT_SIM --> Z_COMBAT_SIM_OTHER["+ 7 smaller modules"]
    ...
    Z_ASSET_REGISTRY --> M_src_mechanist_TileSemanticAssetAuthority_java["src/mechanist/TileSemanticAssetAuthority.java<br/>17 funcs / 256 lines"]
    Z_ASSET_REGISTRY --> M_src_mechanist_TileInfopediaAuthority_java["src/mechanist/TileInfopediaAuthority.java<br/>11 funcs / 250 lines"]
    Z_ASSET_REGISTRY --> M_src_mechanist_assets_AssetRegistry_java["src/mechanist/assets/AssetRegistry.java<br/>17 funcs / 233 lines"]
    ...
    Z_ASSET_REGISTRY --> M_src_mechanist_DefenseSemanticIntegration_java["src/mechanist/DefenseSemanticIntegration.java<br/>14 funcs / 223 lines"]
    ...
    ROOT --> Z_DIAGNOSTIC_DOC["Diagnostics Smoke Audit<br/>17 modules"]
    ...
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_Gate3PresentationAuditSmoke_java["src/mechanist/Gate3PresentationAuditSmoke.java<br/>2 funcs / 35 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_FactionContractDisplaySmoke_java["src/mechanist/FactionContractDisplaySmoke.java<br/>1 funcs / 34 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_PlayerFacingInspectionTextSmoke_java["src/mechanist/PlayerFacingInspectionTextSmoke.java<br/>1 funcs / 34 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_PlayerFacingTextWrapSmoke_java["src/mechanist/PlayerFacingTextWrapSmoke.java<br/>1 funcs / 33 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_PlayerFacingActionTextSmoke_java["src/mechanist/PlayerFacingActionTextSmoke.java<br/>1 funcs / 32 lines"]
    Z_DIAGNOSTIC_DOC --> M_src_mechanist_PlayerFacingCopySanitizerSmoke_java["src/mechanist/PlayerFacingCopySanitizerSmoke.java<br/>1 funcs / 30 lines"]
    Z_DIAGNOSTIC_DOC --> Z_DIAGNOSTIC_DOC_OTHER["+ 5 smaller modules"]
```
