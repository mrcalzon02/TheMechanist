...
`MASTER_DEVELOPMENT_PLAN.md` remains the authoritative roadmap, active checkpoint, phase list, and dependency map. This file is an ordered phase-aligned implementation target for the UI/readability/examination/Infopedia/player-movement/menu-management slice of that roadmap.
...
- `MILESTONE_06_VEHICLES_STRUCTURAL_SCALE_AND_STRATEGIC_POWER.md` where vehicle planned movement mirrors the player movement planning model
...
- Phase 4 - UI, input, rendering, accessibility, display, graphics, options, player movement usability, menu containment, and presentation containment.
...
- Phase 10 - Vehicle inspection, cargo management, crew management, planned vehicle movement, and large-entity readability.
...
Infopedia depth depends on stable semantic entries for items, entities, mechanics, rooms, machines, recipes, factions, statuses, blueprints, qualities, injuries, pets, vehicles, ownership states, movement rules, and provenance states.
...
Management UI depends on shared container, transfer, permission, roster, production, construction, movement intent, and ownership authorities. Menus should not invent parallel state or one-off transfer/movement rules merely because a surface needed a button quickly.

## Phase 4 - Look, Examine, player movement, UI feedback, and menu uniformity
...
### Phase 4.7 - Quest objective guidance overlay pass
...
### Phase 4.8 - Pet interaction feedback pass
...
### Phase 4.9 - Access, construction, and ownership feedback pass
...
### Phase 4.10 - Universal menu trimming, checking, and guideline pass
...
### Phase 4.11 - Universal menu wrapper and navigation grammar pass
...
### Phase 4.12 - Conversation and dialogue interface pass
...
### Phase 4.13 - Trade, barter, vendor, and service interface pass
...
### Phase 4.14 - Inventory and equipment management interface pass
...
### Phase 4.15 - Container, base inventory, and storage management interface pass
...
### Phase 4.16 - Faction member management interface pass
...
### Phase 4.17 - Faction member inventory and equipment management pass
...
### Phase 4.18 - Production and machine management interface pass
...
### Phase 4.19 - Construction and blueprint management interface pass
...
### Phase 4.20 - Construction menu category organization pass
...
## Phase 17 - Quest, ownership, pet, faction, economy, trade, movement, and inventory readability
...
## Phase 18 - Infopedia, hot links, editor, menu definitions, movement definitions, and audit surfaces
...
- Infopedia entries exist for major exposed mechanics, interactions, movement systems, and options added by recent roadmap work.
...
The game may claim in-depth examination, deep Infopedia reference, movement usability, quest guidance, pet interaction feedback, management UI readiness, and player-readable mechanics only after these systems are inspectable, useful, compact, uniform, and free of ordinary debug leakage.
...
This milestone does not complete all UI implementation. It defines the readability, movement, examination, Infopedia, and menu-uniformity targets that later UI implementation must satisfy.

This milestone does not require every item/entity/mechanic/menu to have a perfect final entry immediately. It requires exposed systems to move toward Infopedia coverage, shared menu grammar, movement-input consistency, and hot-linked player reference instead of remaining undocumented or isolated.

This milestone does not authorize external detached utility windows for normal play. Ordinary movement, conversation, trade, inventory, production, construction, faction, and management UI should remain game-owned unless the user explicitly orders a developer-only tool.
