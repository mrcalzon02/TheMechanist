...
final class AccessibilityVisualOptionsRuntime {
    private AccessibilityVisualOptionsRuntime() {}
    ...
    static void pushCurrentScreenNarration(GamePanel panel) { AccessibilityRuntimeOptionsSubsystem.pushCurrentScreenNarration(panel); }
    static void cycleColorTarget(GamePanel panel) { panel.logEvent(OptionsBoundaryAuthority.cycleColorTarget(panel.options)); panel.repaint(); }
    static void cycleColorPreset(GamePanel panel) { panel.logEvent(OptionsBoundaryAuthority.cycleColorPreset(panel.options)); panel.repaint(); }
    static void adjustSelectedColor(GamePanel panel, int delta) { panel.logEvent(OptionsBoundaryAuthority.adjustSelectedColor(panel.options, delta)); panel.repaint(); }
    static java.awt.Color optionColor(GamePanel panel, int key) { return OptionsBoundaryAuthority.optionColor(panel.options, key); }
}
