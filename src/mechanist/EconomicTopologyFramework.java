...
final class EconomicTopologyFramework {
    ...
    static FactionDoctrine doctrineFor(Faction faction) {
        ...
        if (n.contains("MECHANIST COLLEGIA")) return doctrineByFaction(Faction.MECHANIST COLLEGIA);
    ...
    private static EnumMap<ZoneType, ZonePurposeProfile> buildZonePurposeProfiles() {
        ...
        put(m, ZoneType.ARBITES_PRECINCT_EDGE, ZonePurpose.LAW_SECURITY_NODE, Faction.CIVIC WARDENS, InfrastructureAgeBand.MAINTAINED,
        ...
        put(m, ZoneType.MECHANICUS_RELIC_DUCT, ZonePurpose.MECHANICUS_RELIC_SERVICE, Faction.MECHANIST COLLEGIA, InfrastructureAgeBand.INHERITED,
        ...
        put(m, ZoneType.ADMINISTRATUM_ARCHIVE, ZonePurpose.ADMINISTRATIVE_CONTROL_ARCHIVE, Faction.CIVIC LEDGER OFFICE, InfrastructureAgeBand.MAINTAINED,
                new CirculationClass[]{CirculationClass.ADMINISTRATIVE_QUEUE_LINE, CirculationClass.PUBLIC_SERVICE_SPINE},
        ...
        put(m, ZoneType.MECHANICUS_FORGE_CLOISTER, ZonePurpose.FORGE_CLOISTER, Faction.MECHANIST COLLEGIA, InfrastructureAgeBand.MAINTAINED,
    ...
    private static ArrayList<FactionDoctrine> buildDoctrineProfiles() {
        ...
        out.add(new FactionDoctrine(Faction.MECHANIST COLLEGIA, "Forge-cloister industrial doctrine", "dominates metallurgy, machine parts, maintenance rites, refining, and technical infrastructure",
        ...
        out.add(new FactionDoctrine(Faction.CIVIC WARDENS, "Precinct control doctrine", "turns corridors, counters, cells, and records into lawful choke points",
        ...
        out.add(new FactionDoctrine(Faction.CIVIC LEDGER OFFICE, "Bureaucratic control doctrine", "converts queues, files, forms, stamped permissions, and clerical labor into access control",
