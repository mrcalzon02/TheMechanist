...
final class SimulationToolSuiteRegistry {
    ...
    private static final List<ToolSpec> SPECS = List.of(
            ...
            new ToolSpec(ECONOMY_EDITOR, false, 42, "economy bracket", "faction market and provenance ledgers", "Finite reserves, provenance, legality, market policy, shipment, scarcity, and contract-hook records.", "reserves,provenance,legality,vendors,shipments,scarcity,contracts,live world refresh,mod export"),
