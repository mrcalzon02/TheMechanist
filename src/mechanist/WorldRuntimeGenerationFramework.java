...
class World {
    ...
    ArrayList<SecuritySupplyReserveRecord> securitySupplyReserves = new ArrayList<>();
    ArrayList<MedicalSupplyReserveRecord> medicalSupplyReserves = new ArrayList<>();
    ArrayList<NobleLuxuryReserveRecord> nobleLuxuryReserves = new ArrayList<>();
    ArrayList<DraughtCustodyRecord> draughtCustodyRecords = new ArrayList<>();
    ArrayList<AnimalAgricultureSupplyReserveRecord> animalAgricultureSupplyReserves = new ArrayList<>();
    ArrayList<RawMaterialSupplyReserveRecord> rawMaterialSupplyReserves = new ArrayList<>();
    ArrayList<ShipmentProvenanceRecord> shipmentRecords = new ArrayList<>();
    ArrayList<DeferredFactionLedgerRecord> deferredFactionLedgers = new ArrayList<>();
    ArrayList<TopDownWorldEventRecord> topDownWorldEvents = new ArrayList<>();
    long nextTopDownWorldEventCheckTurn = 0L;
    int topDownWorldEventGenerationCount = 0;
    ...
    void worldgenPhaseRoomsAndFactionClaims(WorldGenerationPipelineRunState state){
        ...
        FactionFacilityPlacementAuthority.Result factionFacilityResult = FactionFacilityPlacementAuthority.apply(this, r);
        DebugLog.audit("FACTION_FACILITY_PLACEMENT", factionFacilityResult.summary());
        FactionImportNodeGenerationAuthority.Result importNodePlan = FactionImportNodeGenerationAuthority.promoteAndPlan(this, r);
        DebugLog.audit("FACTION_IMPORT_NODE_PLAN", importNodePlan.summary());
    ...
    void worldgenPhaseRoadAdjacencyFixturesAndValidation(WorldGenerationPipelineRunState state){
        ...
        int promotedFacilityFixtures = FactionFacilityPlacementAuthority.ensureFacilityFixtures(this, r);
        if(promotedFacilityFixtures > 0) DebugLog.audit("FACTION_FACILITY_FIXTURES", "guaranteedSemanticFixtures="+promotedFacilityFixtures+" zone="+zoneType.label);
        FactionImportNodeGenerationAuthority.Result importNodePlacement = FactionImportNodeGenerationAuthority.placePhysicalNodes(this, r);
        DebugLog.audit("FACTION_IMPORT_NODE_PLACEMENT", importNodePlacement.summary());
    ...
    void populate(){
        ...
        int factionFacilityStaff = FactionFacilityPlacementAuthority.staffPromotedFacilities(this, r);
