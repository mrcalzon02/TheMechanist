...
class RoomProfile {
    ...
    static RoomProfile centralPlaza(ZoneType z, boolean sewer, Random r){
        ...
        else if(z==ZoneType.ARBITES_PRECINCT_EDGE){ name="Civic Wardens Precinct Lobby"; desc="a hard-lit precinct lobby with public counters, barred access, queue rails, and armed personnel behind every meaningful door"; fac=Faction.CIVIC WARDENS; contents=new char[]{'A','q','b','n','N'}; }
        else if(z==ZoneType.MECHANICUS_FORGE_CLOISTER || z==ZoneType.MECHANICUS_RELIC_DUCT){ name="Mechanist Collegia Machine Plaza"; desc="a red-lit machinery nave of emergency machines, relay shrines, maintenance lecterns, and humming industrial organs"; fac=Faction.MECHANIST COLLEGIA; contents=new char[]{'N','R','Z','Y','J','P','F'}; }
        else if(z==ZoneType.ADMINISTRATUM_ARCHIVE){ name="Civic Ledger Office Queue Plaza"; desc="a central bureaucratic hall of counters, line rails, stamped notices, clerks, and citizens ageing in public"; fac=Faction.CIVIC LEDGER OFFICE; contents=new char[]{'q','h','b','T','n'}; }
    ...
    static void addCivilianRooms(ArrayList<RoomProfile> list, ZoneType z){
        ...
        list.add(themedRoom("Permit Storefront", "a narrow counter selling legal patience: form packets, water claims, ration stamps, and small humiliations", 36, Faction.CIVIC LEDGER OFFICE, new String[]{"permit stub","ration ticket","trade chit","ink cartridge"}, new char[]{'q','h','b'}));
    ...
    static void addArbitesRooms(ArrayList<RoomProfile> list){
        list.add(themedRoom("Civic Wardens Duty Barracks", "brutalist bunks, boot cages, weapon discipline charts, and sleep treated as a punishable necessity", 26, Faction.CIVIC WARDENS, new String[]{"sealed water ration","ammo scrap","permit scrap"}, new char[]{'A','c','b','q'}));
        list.add(themedRoom("Precinct Mess Slot", "ration trays, steel benches, recaff stains, and silence sharpened by rank", 30, Faction.CIVIC WARDENS, new String[]{"guard ration","sealed water ration","cheap meal tin"}, new char[]{'T','A','q'}));
        list.add(themedRoom("Evidence Storehouse", "tagged food, confiscated water, property bags, and labels pretending custody equals justice", 42, Faction.CIVIC WARDENS, new String[]{"confiscated trinket","permit scrap","sealed water ration","trade chit"}, new char[]{'b','A','q'}));
        list.add(themedRoom("Contraband Warehouse", "barred product cages, sealed weapons crates, chem lockers, and a clerk with keys like teeth", 48, Faction.CIVIC WARDENS, new String[]{"ammo scrap","machine scrap","chem vial","rusted blade"}, new char[]{'b','A','N'}));
        list.add(themedRoom("Public Complaint Counter", "armored glass, forms, queue rails, and a window designed to make rage speak politely", 24, Faction.CIVIC WARDENS, new String[]{"permit scrap","citation slip","ink cartridge"}, new char[]{'q','A','h'}));
        list.add(themedRoom("Holding Cell Row", "steel bunks, floor drains, numbered doors, and wall scratches filed under confession", 20, Faction.CIVIC WARDENS, new String[]{"cloth scraps","bone charm","sealed water ration"}, new char[]{'A','c','u'}));
        list.add(themedRoom("Interrogation Room", "one table, two chairs, bright lamp, drain, and the architectural belief that truth fears discomfort", 18, Faction.CIVIC WARDENS, new String[]{"permit scrap","cloth scraps"}, new char[]{'A','T','q'}));
        list.add(themedRoom("Checkpoint Armory", "baton racks, ammo cabinets, riot shields, and a red line civilians are expected to understand", 34, Faction.CIVIC WARDENS, new String[]{"ammo scrap","shock cell","machine parts"}, new char[]{'A','b','N'}));
    }
    ...
    static void addAdministratumRooms(ArrayList<RoomProfile> list){
        list.add(themedRoom("Clerk Dormitory Ledger Cell", "narrow bunks folded between filing cages, grey blankets, and dreams stamped invalid", 30, Faction.CIVIC LEDGER OFFICE, new String[]{"permit scrap","cloth scraps","sealed water ration"}, new char[]{'h','c','q'}));
        list.add(themedRoom("Stamp-Clerk Canteen", "thin soup, recaff urns, form talk, and benches worn by generations of minor authority", 36, Faction.CIVIC LEDGER OFFICE, new String[]{"cheap meal tin","sealed water ration","ink cartridge"}, new char[]{'T','q','h'}));
        list.add(themedRoom("Ration File Storehouse", "food claims, water tokens, emergency allotments, and paperwork proving hunger was scheduled", 46, Faction.CIVIC LEDGER OFFICE, new String[]{"ration ticket","emergency ration","sealed water ration","permit stub"}, new char[]{'b','h','q'}));
        list.add(themedRoom("Form Product Warehouse", "blank forms, ink barrels, seal ribbons, spare queue rails, and crates no one may open without Form 19", 50, Faction.CIVIC LEDGER OFFICE, new String[]{"blank form packet","ink cartridge","permit scrap","trade chit"}, new char[]{'b','h','N'}));
        list.add(themedRoom("Permit Appeal Counter", "a small counter where hope is made to wait until it becomes paper dust", 28, Faction.CIVIC LEDGER OFFICE, new String[]{"permit stub","petition scrap","ink cartridge"}, new char[]{'q','h','b'}));
        list.add(themedRoom("Dead-File Vault", "old names, failed claims, sealed shelves, and the soft rot of lives completed administratively", 42, Faction.CIVIC LEDGER OFFICE, new String[]{"permit scrap","identity slate","cloth scraps"}, new char[]{'h','b','q'}));
        list.add(themedRoom("Queue Pen", "rail mazes, tired benches, number lamps, and a social machine for turning time into submission", 22, Faction.CIVIC LEDGER OFFICE, new String[]{"ration ticket","permit stub","cheap trinket"}, new char[]{'h','q','n'}));
        list.add(themedRoom("Archive Maintenance Niche", "rolling ladders, dust filters, cable trays, and a machine that indexes misery", 48, Faction.CIVIC LEDGER OFFICE, new String[]{"filter cartridge","wire bundle","logic Engine shard"}, new char[]{'N','h','q'}));
    }
    ...
    static void addMechanicusRooms(ArrayList<RoomProfile> list, ZoneType z){
        list.add(themedRoom("Augmetic Rest Cell", "a human-unfriendly recess of angled metal, standing restraint rails, cable ports, and a cot added only as a concession to biology", 34, Faction.MECHANIST COLLEGIA, new String[]{"wire bundle","cloth scraps","sacred oil dreg"}, new char[]{'R','c','N'}));
        list.add(themedRoom("Nutrient Reclamation Galley", "tube-fed ration pumps, bitter electrolyte tanks, and a dining arrangement optimized for maintenance servitors", 42, Faction.MECHANIST COLLEGIA, new String[]{"nutrient paste","sealed water ration","filter cartridge"}, new char[]{'Y','N','T'}));
        list.add(themedRoom("Blessed Lubricant Storehouse", "oil phials, coolant cans, feedstock barrels, and purity tags hanging from every valve", 56, Faction.MECHANIST COLLEGIA, new String[]{"sacred oil dreg","hot oil phial","filter cartridge","fuel scrap"}, new char[]{'b','R','N'}));
        list.add(themedRoom("Component Warehouse", "sorted machine limbs, cable bundles, logic Engine plates, and jagged shelving hostile to soft hands", 60, Faction.MECHANIST COLLEGIA, new String[]{"machine parts","wire bundle","logic Engine shard","construction supplies"}, new char[]{'b','N','R','J'}));
        list.add(themedRoom("Inspection Counter Shrine", "a service counter disguised as an altar, where devices are judged more gently than people", 46, Faction.MECHANIST COLLEGIA, new String[]{"machine scrap","trade chit","sacred oil dreg"}, new char[]{'q','R','N'}));
        list.add(themedRoom("Diagnostic Bay", "auspex arms, warning lumens, suspended cables, and floor plates cut for machines instead of feet", 52, Faction.MECHANIST COLLEGIA, new String[]{"logic Engine shard","wire bundle","sample vial"}, new char[]{'R','N','Z'}));
        list.add(themedRoom("Cable Chapel", "hanging conduit, red lamps, incense vents, and devotional sockets humming under the walls", 38, Faction.MECHANIST COLLEGIA, new String[]{"wire bundle","sacred oil dreg","wax scrap"}, new char[]{'c','R','N'}));
        list.add(themedRoom("Servo-Skull Rookery", "charging perches, tiny tool nests, data droppings, and the anxious flutter of loyal dead hardware", 44, Faction.MECHANIST COLLEGIA, new String[]{"logic Engine shard","machine parts","wire bundle"}, new char[]{'R','q','N'}));
        if(z==ZoneType.MECHANICUS_RELIC_DUCT) list.add(themedRoom("Relic Duct Access Shrine", "ancient actuator teeth, sealed access wheels, data frost, and warnings written for people already gone", 50, Faction.MECHANIST COLLEGIA, new String[]{"logic Engine shard","machine parts","relic tag"}, new char[]{'R','M','N'}));
    }
    ...
    static void addRailRooms(ArrayList<RoomProfile> list, ZoneType z){
        ...
        list.add(themedRoom("Cargo Inspection Cage", "barred tables, seal knives, ledgers, and inspectors who can smell undeclared hope", 38, Faction.CIVIC WARDENS, new String[]{"permit scrap","supply docket","confiscated trinket"}, new char[]{'A','b','q'}));
    ...
    static RoomProfile forZone(ZoneType z, Random r){
        ...
        if(z==ZoneType.MECHANICUS_FORGE_CLOISTER || z==ZoneType.MECHANICUS_RELIC_DUCT){
            list.add(new RoomProfile("Atmospheric Condenser Cell","Martian condenser room: damp coils, intake vanes, and emergency water recovery hardware",44,Faction.MECHANIST COLLEGIA,new String[]{"water bottle","filter cartridge","machine parts"},new char[]{'Y','N','q'}));
            list.add(new RoomProfile("Emergency Assembler Niche","Martian assembler room: tiny manipulators, feed chutes, and a machine that wants instructions",48,Faction.MECHANIST COLLEGIA,new String[]{"machine parts","wire bundle","construction supplies"},new char[]{'J','N','q'}));
            list.add(new RoomProfile("Emergency Boiler Annex","Martian boiler room: hot pipes, pressure gauges, dirty water, and usable fuel",42,Faction.MECHANIST COLLEGIA,new String[]{"dirty water","fuel scrap","machine parts"},new char[]{'B','N','q'}));
            list.add(new RoomProfile("Micro Laboratorium Closet","Martian lab room: sample trays, sealed lenses, and ritualized diagnostic mess",36,Faction.MECHANIST COLLEGIA,new String[]{"logic Engine shard","filter cartridge","sample vial"},new char[]{'K','q','N'}));
            list.add(new RoomProfile("Emergency Miner Bay","Martian miner room: bite-head drill assembly and enough noise to invite visitors",38,Faction.MECHANIST COLLEGIA,new String[]{"raw iron ore","raw copper ore","machine parts"},new char[]{'O','N','q'}));
            list.add(new RoomProfile("Power Grid Relay Room","Martian power relay room: switch rails, insulated grids, and ownership signs nobody sane ignores",34,Faction.MECHANIST COLLEGIA,new String[]{"wire bundle","machine parts","fuse block"},new char[]{'Z','N','q'}));
            list.add(new RoomProfile("Emergency Smelter Cell","Martian smelter room: heat scarred floor plates and ore feed gates",40,Faction.MECHANIST COLLEGIA,new String[]{"raw iron ore","raw copper ore","fuel scrap"},new char[]{'P','N','q'}));
            list.add(new RoomProfile("Steam Engine Chamber","Martian steam engine room: piston mass, pressure brass, and a very sabotageable heart",32,Faction.MECHANIST COLLEGIA,new String[]{"fuel scrap","machine parts","dirty water"},new char[]{'F','N','q'}));
        }
