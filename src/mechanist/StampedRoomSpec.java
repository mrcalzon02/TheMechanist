...
class StampedRoomSpec {
    final String kind, name, descriptor; final int scavengeChance; final Faction faction; final String[] loot; final char[] contents;
    StampedRoomSpec(String kind, String name, String descriptor, int scavengeChance, Faction faction, String[] loot, char[] contents){
        this.kind=kind; this.name=name; this.descriptor=descriptor; this.scavengeChance=scavengeChance; this.faction=faction; this.loot=loot; this.contents=contents;
    }
